...
| [`filter-features.json`](filter-features.json) | Feature-Katalog der Filter-Engine: 25 Features mit Berechnung, Datenquelle, Signalrichtung, Schwellen-Anhaltspunkten |
...
| [`filter-engine.md`](../docs/filter-engine.md) | Filter-Engine im Detail: EV-Mathematik, 4-Stufen-Architektur, K.-o.-Liste, ML-Training, Bundle-/Wash-Algorithmen |
