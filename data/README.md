...
| [`ai-business-models.json`](ai-business-models.json) | Legale & ethische KI-Geschäftsmodelle: Creator-Launches, SaaS, Daten, Services – mit Ethik-/Rechts-Anforderungen |
| [`filter-features.json`](filter-features.json) | Feature-Katalog der Filter-Engine: 26 Features mit Berechnung, Datenquelle, Signalrichtung, Schwellen-Anhaltspunkten |
| [`detection-apis.json`](detection-apis.json) | Detektions-APIs mit verifizierten Feldnamen: RugCheck, GoPlus, SolanaTracker, GMGN, SolSniffer, PumpPortal/Helius/Bitquery-Streams |
| [`fee-sources.json`](fee-sources.json) | Fee-Quellen-Katalog: exakte Sätze, Splits, Claim-Mechanik und Historie aller Plattformen/Bots (recherchiert Sept 2026) |
...
| [`ai-geschaeftsmodelle.md`](../docs/ai-geschaeftsmodelle.md) | Legal & ethisch verdienen: Ertragspyramide, Creator-Launch-Playbook, Service-Schiene, Regulierungs-Landkarte |
| [`filter-engine.md`](../docs/filter-engine.md) | Filter-Engine im Detail: EV-Mathematik, 4-Stufen-Architektur, K.-o.-Liste, ML-Training, Bundle-/Wash-Algorithmen, verifizierte Statistiken & Forschung |
| [`fee-oekonomie.md`](../docs/fee-oekonomie.md) | Fee-Ökonomie: pump.fun-Fee-Historie, PumpSwap-Tier-Tabelle, Plattform-Vergleich, Referral-Ökonomie, monatliche Ist-Zahlen |
